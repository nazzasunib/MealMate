  ...
  return (
    '<div class="space-y-6">' +
      '<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">' +
        ...
        '<div class="flex items-center gap-2">' + dateSwitcherHtml(dateKey) + '<button data-action="add-guest-meal" data-date="' + dateKey + '" class="btn-primary">' + icon("user-plus", "h-4 w-4") + "Guest Meal</button></div>" +
      "</div>" +
